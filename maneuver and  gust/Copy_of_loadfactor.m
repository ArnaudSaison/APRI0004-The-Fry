...
mu_g=2*(W/S_w)/(rho_star*c0*9.81*CLa);
K=0.88*mu_g/(5.3+mu_g);

n_VC_plus=1+rho0*K*UeVC*0.3048*VC*CLa/(2*(W/S_w));
n_VC_moins=1-rho0*K*UeVC*0.3048*VC*CLa/(2*(W/S_w));
n_VD_plus=1+rho0*K*UeVD*0.3048*VD*CLa/(2*(W/S_w));
n_VD_moins=1-rho0*K*UeVD*0.3048*VD*CLa/(2*(W/S_w));
