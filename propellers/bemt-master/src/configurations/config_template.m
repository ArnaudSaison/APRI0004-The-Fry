...
Blades.COEFF_FILE   = 'naca0012polar.mat';  % Airfoil polars for various Reynolds

Blades.OMEGArpm = 2400;     % Rotational speed, [RPM]
Blades.nELEM    = 100;      % Number of blade elements

Blades.nBLADES          = 4;        % Number of blades on the rotor
Blades.RADIUS           = 1.8/2;    % Radius (from HUB center to tip), [m]
