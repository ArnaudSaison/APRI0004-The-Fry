function [Results, Elem, Param, Blades] = optiRotationalVel(Param, Blades, target_T, a, b)
...
if max_iter >= i
    disp(['Optimal OMEGArpm found after ', num2str(i), ' iterations']);
else
