...
res.climb.time = (par.cruise_altitude - par.to_alt) / par.climb_rate; % [s] time to reach cruise altitude
...
% res.cruise.C_D = 0.0329; % final value
par.C_L_minD = 2 * par.W_to / (par.rho_0 * res.cruise.V^2 * par.S);
