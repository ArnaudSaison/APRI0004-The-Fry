...
disp(['<strong>  • HLP thrust = </strong>', ...
num2str(res.T_BWE_to / 1000), ' [kN]  /  ']);

disp(['<strong>  • tot HLP thrust = </strong>', ...
num2str(res.T_tot_BWE_to / 1000), ' [kN]  /  ']);
...
disp(['<strong>Power of the engine = </strong>', ...
num2str(res.climb.P_available / 1000), ' [kW]  /  ', ...
num2str(res.climb.P_available / 746), ' [imp. hp]']);
...
num2str(res.landing.dist_g), ' [m]']);
disp(['<strong>Total landing distance = </strong>', ...
num2str(res.landing.dist_tot), ' [m]']);
...
disp(['<strong>  • Mass left after fuel = </strong>', ...
num2str(res.en.mass_left_after_fuel), ' [kg]']);
